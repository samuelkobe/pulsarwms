<section class="my-8 xl:my-16">
    <div class="flex contained">
        <h2 class="text-2xl sm:text-3xl xl:text-4.5xl xl:leading-snug mb-4 xl:mb-8 font-title font-semibold uppercase text-brand-dark text-center"><?php the_sub_field( 'faq_title' ); ?></h2>
