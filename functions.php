...
function footer_scripts()
{
  ...
  if (is_page('calc') || is_page('pricing')) {
    wp_register_script('calc', get_template_directory_uri() . '/js/calc-settings.js'); // Conditional script(s)
    wp_enqueue_script('calc'); // Enqueue it!
  }
...
function register_menu()
{
    register_nav_menus(array( // Using array to specify more menus if needed
        ...
        'footer-menu-one' => __('Footer Menu 1', 'web-ok-starter'), // Header/Main Navigation
        'footer-menu-two' => __('Footer Menu 2', 'web-ok-starter'), // Header/Main Navigation
        'footer-menu-three' => __('Footer Menu 3', 'web-ok-starter'), // Header/Main Navigation
    ));
}
